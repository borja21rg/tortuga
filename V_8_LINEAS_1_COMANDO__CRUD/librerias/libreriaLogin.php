        ...
        <div class='col-md-6 mx-auto py-4 px-0'>
            ...
            <div class='card p-0 rounded'>
                ...
                <form class='signup justify-content-center' name='inicio' action='".$_SERVER['PHP_SELF']."' method='post'>
                    ...
                    <div class='form-group'><span class='col-md-1 col-md-offset-2 text-center'><i class='fa fa-user bigicon'></i></span><input type='text' class='form-control' placeholder='Usuario' name='nombre' required></div>
