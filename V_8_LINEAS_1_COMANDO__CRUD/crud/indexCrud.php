...
<body>
    ...
    <div class='container-fluiz'>
        ...
        <header class='row '>
            <h1 class='col text-center p-4 '>Gestión de Usuarios</h1>
        </header>
                    ...
                    <tbody>
                        ...
                        foreach ($registros as $usuario) : ?>
                            <tr class="table-active">
                                ...
                                <td class="bot"><a href="borrar.php?id=<?= $usuario->id ?>"><input class='crud' type='button' name='del' id='del' value='Borrar'></a></td>
                                <td class='bot'><a href="actualizar.php?id=<?= $usuario->id ?>&cla=<?= $usuario->clave ?>&nom=<?= $usuario->nombreUsuario ?>&des=<?= $usuario->descripcion ?>&per=<?= $usuario->perfil ?>&act=<?= $usuario->activo ?>"><input class='crud' type='button' name='up' id='up' value='Actualizar'></a></td>
                            </tr>
                        <?php endforeach;
